...
-- (Linkedin: https://www.linkedin.com/posts/lasya-nandini_sql-activity-7396026817809215488-lF2C?utm_source=share&utm_medium=member_desktop&rcm=ACoAADC2EUIBuIUuGCjehcsh_Ols7cwKTCRKFIY)
...
with drop_duplicates as (
    select 
        ...
        row_number() over (partition by department,salary) as rn
    from employees
)
,ranking as (
select department,
